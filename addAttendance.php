...
if (isset($_POST['addAttendanceBTN'])) {
    ...
    if (isset($_POST['studentPresent'])) {
        ...
        foreach ($studentPresent as $atd) {
            mysqli_query($db, "INSERT INTO add_attendance(student_id, curr_date, attendance_month, attendance_year, attendance) VALUES ('" . $atd . "', '" . $selected_date . "', '" . $attendance_month . "', '" . $attendance_year . "', '" . $attendance . "')") OR die(mysqli_error($db));
        }
    }
